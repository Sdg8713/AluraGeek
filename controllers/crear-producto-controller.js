...
function iniciarApp() {
    ...
    btnRegistarProducto.listaProductos.add('btn-desactivado');
...
function validarForm(e) {
    ...
    if (e.target.value === '') {
        ...
        e.target.listaProductos.add('campo-error');

    } else {
        e.target.listaProductos.remove('campo-error');
    }

    if (inputNombre.value != '' && inputPrecio.value != '' && inputURLImagen.value != '' && inputCategoria.value != '') {
        btnRegistarProducto.listaProductos.remove('btn-desactivado');
...
function mostrarMensaje(msj, tipo) {
    ...
    mensaje.listaProductos.add(tipo);
